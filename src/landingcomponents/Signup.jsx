        ...
        <>
            <form>
                <div className="mt-2 space-y-4">
                    <div>
                        <label className="block mb-3 text-sm font-medium text-gray-100" htmlFor="name">
                            Username
                        </label>
                        <input
                    ...
                    <div className="col-span-full">
                        ...
                        <input
                            ...
                            type="password"
                        />
                        <p className='mt-2 text-sm text-gray-400'>Use 8 or more characters with a mix of letters, numbers & symbols</p>
                    </div>
                    <div className="col-span-full">
                        <button
